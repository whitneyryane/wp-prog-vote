<select id="timezone-string" name="timezone-string" aria-describedby="timezone-description">
...
<p class="description" id="timezone-description">
    ...
    <?php _e( 'Choose either a city in the same timezone as you or a UTC timezone offset.', $this->plugin_name ); ?>
...
<p class="timezone-info">
    ...
    <span id="utc-time">
        ...
        <?php _e( 'Universal time (<abbr>UTC</abbr>) is', $this->plugin_name ); ?> <code><?php

		echo gmdate( "M d Y H:i:s" ); 

        date_default_timezone_set( "America/Los_Angeles" );?></code>.
